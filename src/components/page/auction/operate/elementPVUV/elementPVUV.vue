<template>
  <div class="elementPVUV" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
    <div class="date-filter">
      <li>
        ...
        <el-date-picker v-model.trim="startTime" type="date" size="mini" placeholder="从"
                        class="elementPVUVTimeSelect" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
              class="elementPVUV-table" @sort-change="sort">
      <el-table-column property="d_date" sortable="custom" label="日期"></el-table-column>
      <el-table-column property="page_name" label="元素所在页面" min-width="130"></el-table-column>
      <el-table-column property="element" label="元素名称" min-width="130"></el-table-column>
      <el-table-column property="pv" sortable="custom" label="点击次数" min-width="130"></el-table-column>
      <el-table-column property="uv" sortable="custom" label="点击人数" min-width="130"></el-table-column>
    </el-table>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/elementPVUV/excel?startTime="' + [this.startTime, 'DATE'] + '"' + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
