<template>
  <div class="monthlySettlementData" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
...
<script type="text/ecmascript-6">
  ...
  import {
    ...
    getMonthlySettlementDataCount,
    getMonthlySettlementDataRefresh
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/monthlySettlementData/excel?startTime="' + [this.startTime, 'MONTH'] + '"&endTime="' + [this.endTime, 'MONTH'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getMonthlySettlementData({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount() {
        return getMonthlySettlementDataCount({
          startTime: [this.startTime, 'MONTH'],
          endTime: [this.endTime, 'MONTH']
        })
      },
      ...
      refreshData() {
        ...
        getMonthlySettlementDataRefresh().then((response) => {
