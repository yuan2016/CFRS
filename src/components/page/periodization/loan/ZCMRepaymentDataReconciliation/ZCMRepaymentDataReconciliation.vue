<template>
  <div class="ZCMRepaymentDataReconciliation" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
              class="ZCMRepaymentDataReconciliation-table" @sort-change="sort" :cell-style="cellStyle">
      <el-table-column property="D_DATE" fixed sortable="custom" label="日期"  min-width="120"></el-table-column>
      <el-table-column property="d_month" sortable="custom" label="月份" min-width="100"></el-table-column>
      <el-table-column label="结算分析">
        ...
        <el-table-column property="OVERDUE_REPAYMENT_AMT" sortable="custom" label="逾期还款本金(元)" min-width="160"></el-table-column>
        <el-table-column property="OVERDUE_REPAYMENT_INTEREST" sortable="custom" label="逾期还款利息(元)" min-width="160"></el-table-column>
        <el-table-column property="OVERDUE_LATE_FEE" sortable="custom" label="逾期滞纳金(元)" min-width="160"></el-table-column>
        <el-table-column property="RENEWAL_FEE" sortable="custom" label="续期费(元)" min-width="160"></el-table-column>
        <el-table-column property="TOTAL_AMT" sortable="custom" label="合计(元)" min-width="160"></el-table-column>
      </el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getZCMRepaymentDataReconciliation,
    getZCMRepaymentDataReconciliationCount,
    getZCMRepaymentDataReconciliationRefresh
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/ZCMRepaymentDataReconciliation/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getZCMRepaymentDataReconciliation({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount() {
        return getZCMRepaymentDataReconciliationCount({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
      ...
      refreshData() {
        ...
        getZCMRepaymentDataReconciliationRefresh().then((response) => {
