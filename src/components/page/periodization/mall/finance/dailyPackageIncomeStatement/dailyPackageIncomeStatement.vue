<template>
  <div class="dailyPackageIncomeStatement" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
              class="dailyPackageIncomeStatement-table" @sort-change="sort">
      ...
      <el-table-column property="dlb_quota" sortable="custom" label="大礼包额度(元)" min-width="130"></el-table-column>
      <el-table-column property="dlb_income" sortable="custom" label="礼包收入(元)" min-width="130"></el-table-column>
      <el-table-column property="dlb_refund" sortable="custom" label="礼包退款(元)" min-width="130"></el-table-column>
      <el-table-column property="dlb_income_balance" sortable="custom" label="礼包收入余额(元)" min-width="140"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getDailyPackageIncomeStatement,
    getDailyPackageIncomeStatementCount,
    getDailyPackageIncomeStatementRefresh
  } from '../../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/dailyPackageIncomeStatement/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getDailyPackageIncomeStatement({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount() {
        return getDailyPackageIncomeStatementCount({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
      ...
      refreshData() {
        ...
        getDailyPackageIncomeStatementRefresh().then((response) => {
