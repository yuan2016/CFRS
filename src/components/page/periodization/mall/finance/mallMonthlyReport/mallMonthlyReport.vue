<template>
  <div class="mallMonthlyReport" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
      ...
      <el-table-column property="dlb_income" sortable="custom" label="大礼包收入(元)" min-width="140"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getMallMonthlyReport,
    getMallMonthlyReportCount,
    getMallMonthlyReportRefresh
  } from '../../../../../../common/js/api'
  ...
  export default {
    ...
    methods: {
      ...
      refreshData() {
        ...
        getMallMonthlyReportRefresh().then((response) => {
