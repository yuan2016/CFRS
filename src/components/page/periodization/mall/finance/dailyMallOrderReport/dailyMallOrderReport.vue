<template>
  <div class="dailyMallOrderReport" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
              class="dailyMallOrderReport-table" @sort-change="sort">
      ...
      <el-table-column property="free_amount" sortable="custom" label="优惠券使用金额(元)" min-width="150"></el-table-column>
      <el-table-column property="buy_amount" sortable="custom" label="零钱购买金额(元)" min-width="150"></el-table-column>
      <el-table-column property="debt_amount" sortable="custom" label="白条使用金额(元)" min-width="150"></el-table-column>
      <el-table-column property="amount" sortable="custom" label="数据合计(元)" min-width="140"></el-table-column>
      <el-table-column property="product_amount" sortable="custom" label="商品总额(元)" min-width="140"></el-table-column>
      <el-table-column property="diff" label="差异(元)" sortable="custom" min-width="140"></el-table-column>
    </el-table>
    <div class="pop1">
      <p class="popTop">差异=数据合计-商品总额</p>
    </div>
...
<script type="text/ecmascript-6">
  ...
  import {
    getDailyMallOrderReport,
    getDailyMallOrderReportCount,
    getDailyMallOrderReportRefresh
  } from '../../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/dailyMallOrderReport/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getDailyMallOrderReport({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount() {
        return getDailyMallOrderReportCount({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
      ...
      refreshData() {
        ...
        getDailyMallOrderReportRefresh().then((response) => {
