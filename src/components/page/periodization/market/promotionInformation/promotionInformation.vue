<template>
  <div class="promotionInformation" v-loading.body="loading" element-loading-text="拼命加载中"
  >
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height" class="promotionInformation-table" @sort-change="sort">
      <el-table-column property="realname" fixed label="推广员姓名" min-width="100"></el-table-column>
      <el-table-column property="user_phone" label="推广员电话" min-width="100"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/promotionInformation/excel?realname="' + [this.realname, 'INPUT'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getCount() {
        return getPromotionInformationCount({
          realname: [this.realname, 'INPUT']
        })
      },
      search() {
