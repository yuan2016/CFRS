<template>
  <div class="promotionStatisticsArea" v-loading.body="loading" element-loading-text="拼命加载中">
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
              class="promotionStatisticsArea-table" @sort-change="sort">
      ...
      <el-table-column property="register_num" sortable="custom" label="注册量" min-width="100"></el-table-column>
      <el-table-column property="realname_auth_num" sortable="custom" label="实名认证" min-width="100"></el-table-column>
      <el-table-column property="card_bound_num" sortable="custom" label="绑卡人数" min-width="100"></el-table-column>
      <el-table-column property="emergency_contact_num" sortable="custom" label="紧急联系人" min-width="120"></el-table-column>
      <el-table-column property="operator_auth_num" sortable="custom" label="运营商认证" min-width="120"></el-table-column>
      <el-table-column property="Alipay_auth_num" sortable="custom" label="支付宝认证人数" min-width="140"></el-table-column>
      <el-table-column property="Sesame_auth_num" sortable="custom" label="芝麻认证人数" min-width="120"></el-table-column>
      <el-table-column property="jobinfo_auth_num" sortable="custom" label="工作信息" min-width="100"></el-table-column>
      <el-table-column property="apply_loan_num" sortable="custom" label="申请借款人数" min-width="120"></el-table-column>
      <el-table-column property="apply_succ_num" sortable="custom" label="申请成功人数" min-width="120"></el-table-column>
      <el-table-column property="Pass_rate" sortable="custom" label="通过率" min-width="100"></el-table-column>
      <el-table-column property="loan_amount" sortable="custom" label="放款金额(元)" min-width="120"></el-table-column>
      <el-table-column property="blacklist_num" sortable="custom" label="黑名单人数" min-width="120"></el-table-column>
      <el-table-column property="overdue_num" sortable="custom" label="逾期人数" min-width="100"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getPromotionStatisticsArea,
    getPromotionStatisticsAreaCount
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/promotionStatisticsArea/excel?province="' + [this.province, 'SELECT'] + '"&city="' + [this.city, 'SELECT'] + '"&startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getPromotionStatisticsArea({
      ...
      getCount() {
        return getPromotionStatisticsAreaCount({
          province: [this.province, 'SELECT'],
          city: [this.city, 'SELECT'],
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
      ...
      refreshData() {
        ...
        this.axios.post('/api/promotionStatisticsArea/refresh').then((response) => {
