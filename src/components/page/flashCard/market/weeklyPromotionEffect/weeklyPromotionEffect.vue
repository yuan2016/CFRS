...
<script type="text/ecmascript-6">
  ...
  import {
    getWeeklyPromotionEffect,
    getWeeklyPromotionEffectCount,
    getWeeklyPromotionEffectSelect
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/weeklyPromotionEffect/excel?channel_name="' + [this.channel_name, 'SELECT'] + '"&startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getWeeklyPromotionEffect({
      ...
      getCount() {
        return getWeeklyPromotionEffectCount({
          channel_name: [this.channel_name, 'SELECT'],
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      ...
      getSelectOptions() {
        getWeeklyPromotionEffectSelect().then((response) => {
