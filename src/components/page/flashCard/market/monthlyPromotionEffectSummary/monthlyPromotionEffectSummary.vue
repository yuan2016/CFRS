...
<script type="text/ecmascript-6">
  ...
  import {
    getMonthlyPromotionEffectSummary,
    getMonthlyPromotionEffectSummaryCount,
    getMonthlyPromotionEffectSummarySelect
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/monthlyPromotionEffectSummary/excel?channel_name="' + [this.channel_name, 'SELECT'] + '"&startTime="' + [this.startTime, 'MONTH'] + '"&endTime="' + [this.endTime, 'MONTH'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getMonthlyPromotionEffectSummary({
      ...
      getCount() {
        return getMonthlyPromotionEffectSummaryCount({
          channel_name: [this.channel_name, 'SELECT'],
          startTime: [this.startTime, 'MONTH'],
          endTime: [this.endTime, 'MONTH']
        })
      ...
      getSelectOptions() {
        getMonthlyPromotionEffectSummarySelect().then((response) => {
