<template>
  <div class="registrationStatisticsReport" v-loading.body="loading" element-loading-text="拼命加载中" >
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height" class="registrationStatisticsReport-table" @sort-change="sort">
      ...
      <el-table-column property="loans_total" label="放款总额(元)" min-width="130"></el-table-column>
      <el-table-column property="loans_total_ouser" label="老用户放款总额(元)" min-width="130"></el-table-column>
      <el-table-column property="loans_total_nuser" label="新用户放款总额(元)" min-width="130"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getRegistrationStatisticsReport,
    getRegistrationStatisticsReportCount
  } from '../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink () {
        return 'api/dailyLendingData/excel2?startTime=' + [this.startTime, 'DATE'] + '&endTime=' + [this.endTime, 'DATE']
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData () {
        return getRegistrationStatisticsReport({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount () {
        return getRegistrationStatisticsReportCount({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
