<template>
  <div class="promotionChannelStatistics" v-loading.body="loading" element-loading-text="拼命加载中">
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto" :height="height"
              class="promotionChannelStatistics-table" @sort-change="sort">
      ...
      <el-table-column property="settle_method" label="结算方式" width="130"></el-table-column>
      <el-table-column property="effe_cust_acqu_cost" label="有效获客成本(元)" width="120"></el-table-column>
      <el-table-column property="day_consumption" label="当日消耗(元)" width="100"></el-table-column>
      ...
      <el-table-column property="apply_loan_num_new" label="新用户申请借款人数" width="130"></el-table-column>
      <el-table-column property="apply_loan_num_old" label="老用户申请借款人数" width="130"></el-table-column>
      <el-table-column property="blacklist_num" label="黑名单人数" width="90"></el-table-column>
      ...
      <el-table-column property="BADDEBT_amount" label="坏账金额(元)" width="90"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getPromotionChannelStatistics,
    getPromotionChannelStatisticsCount,
    getPromotionChannelStatisticsSelect,
    getPromotionChannelStatisticsRefresh
  } from '../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/promotionChannelStatistics/excel?channel_trader_name="' + [this.channel_trader_name, 'SELECT'] + '"&startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData() {
        return getPromotionChannelStatistics({
      ...
      getCount() {
        return getPromotionChannelStatisticsCount({
          channel_trader: [this.channel_trader, 'INPUT'],
          channel_trader_name: [this.channel_trader_name, 'SELECT'],
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
      ...
      getSelectOptions() {
        getPromotionChannelStatisticsSelect().then((response) => {
