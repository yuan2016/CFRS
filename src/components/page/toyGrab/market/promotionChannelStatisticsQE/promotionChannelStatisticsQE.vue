<template>
  <div class="promotionChannelStatisticsQE" v-loading.body="loading" element-loading-text="拼命加载中">
    <banner></banner>
    <div class="date-filter">
      <li>
        <span class="managerFront">渠道名称：</span>
        <el-select v-model.trim="channel_name" size="mini" placeholder="不限" class="promotionChannelStatisticsQESelect">
          <el-option
        ...
        <div class="detail-wrapper">
          <div class="detial-main">
            ...
            <el-form :label-position="labelPosition" label-width="120px" :rules="loginRules" :model="formLabelAlign"
                     class="promotionChannelStatisticsQE-form" ref="ruleForm">
              ...
              <el-form-item>
                <el-button type="primary" class="promotionChannelStatisticsQE-button" @click="saveData('ruleForm')">
                  立即修改
                </el-button>
              </el-form-item>
            </el-form>
    ...
    computed: {
       mosaicLink() {
         if (this.startTime === this.endTime || this.startTime === formatDate(new Date(), 'yyyy-MM-dd') || (!this.startTime && !this.endTime)) {
           return 'api/promotionChannelStatisticsQE/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"&channel_name="' + [this.channel_name, 'SELECT'] + '"'
         } else {
           return 'api/promotionChannelStatisticsQE/excelSUM?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"&channel_name="' + [this.channel_name, 'SELECT'] + '"'
         }
       },
      ...mapGetters([
        'permission'
  ...
  .promotionChannelStatisticsQE
    ...
    .date-filter
      li
        .managerText
          width: 160px
        .promotionChannelSelect, .userListTimeSelect, .promotionChannelStatisticsQESelect
          width: 160px
    .detail
      position: fixed
      top: 0
      ...
      .detail-wrapper
        ...
        .detial-main
          ...
          .formula
            ...
            color: #3a8ee6
          .promotionChannelStatisticsQE-form
            margin: 20px 20px 20px 0
          .promotionChannelStatisticsQE-button
            width: 200px
      .detail-close
        position: absolute
        top: 50px
