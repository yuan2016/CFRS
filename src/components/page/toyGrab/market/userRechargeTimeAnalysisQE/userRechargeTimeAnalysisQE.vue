<template>
  <div class="userRechargeTimeAnalysisQE" v-loading.fullscreen="loading" element-loading-text="拼命加载中">
    <banner></banner>
    ...
    <div class="line">
      <span class="can" :style="{ height: height + 'px' }">
        <user-recharge-time-analysis-hourly :message="startTime"></user-recharge-time-analysis-hourly>
      </span>
    </div>
  </div>
</template>
...
<script type="text/ecmascript-6">
  import userRechargeTimeAnalysisHourly from '../../../../charts/userRechargeTimeAnalysisHourly/userRechargeTimeAnalysisHourly'
  ...
  export default {
    ...
    components: {
      userRechargeTimeAnalysisHourly,
      banner
    },
    methods: {
      resizeHeight () {
