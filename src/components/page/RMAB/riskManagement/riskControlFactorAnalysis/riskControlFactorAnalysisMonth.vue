<template>
  <div class="riskControlFactorAnalysis" v-loading.body="loading" element-loading-text="拼命加载中" >
    ...
    <el-table :data="fundData" border highlight-current-row
      ...
      <el-table-column property="M1" :label="labels[2]">
      ...
      <el-table-column property="M2" :label="labels[6]">
      ...
      <el-table-column property="M3" :label="labels[10]">
      ...
      <el-table-column property="M4" :label="labels[14]">
      ...
      <el-table-column property="M5" :label="labels[18]">
      ...
      <el-table-column property="MOM" :label="labels[22]">
...
<script type="text/ecmascript-6">
  ...
  const defaultBlank = ['指标名称', '指标名称', 'M1', 'M1', 'M1', 'M1', 'M2', 'M2', 'M2', 'M2', 'M3', 'M3', 'M3', 'M3', 'M4', 'M4', 'M4', 'M4', 'M5', 'M5', 'M5', 'M5', 'MOM', 'MOM', 'MOM', 'MOM', '申请人数', '通过率', '逾期率', '剩余逾期率']
