<template>
  <div class="riskControlFactorAnalysis" v-loading.body="loading" element-loading-text="拼命加载中" >
    ...
    <el-table :data="fundData" border highlight-current-row
      ...
      <el-table-column property="W1" :label="labels[2]">
      ...
      <el-table-column property="W2" :label="labels[6]">
      ...
      <el-table-column property="W3" :label="labels[10]">
      ...
      <el-table-column property="W4" :label="labels[14]">
      ...
      <el-table-column property="W5" :label="labels[18]">
      ...
      <el-table-column property="WOW" :label="labels[22]">
        <el-table-column property="d61" :label="Pdata[22]"></el-table-column>
        <el-table-column property="d62" :label="Pdata[21]"></el-table-column>
        <el-table-column property="d63" :label="Pdata[23]"></el-table-column>
        <el-table-column property="d64" :label="Pdata[24]"></el-table-column>
      </el-table-column>
    </el-table>
    <div class="pop1">
...
<script type="text/ecmascript-6">
  ...
  const defaultBlank = ['指标名称', '指标名称', 'W1', 'W1', 'W1', 'W1', 'W2', 'W2', 'W2', 'W2', 'W3', 'W3', 'W3', 'W3', 'W4', 'W4', 'W4', 'W4', 'W5', 'W5', 'W5', 'W5', 'WOW', 'WOW', 'WOW', 'WOW', '申请人数', '通过率', '逾期率', '剩余逾期率']
  ...
  export default {
    ...
    methods: {
      ...
      changeValue () {
        ...
        if (value === '日') {
          this.$router.push({path: 'riskControlFactorAnalysis', query: {loan_term: this.loan_term, customer_type: this.customer_type, syyq_zb: this.syyq_zb}})
        } else if (value === '周') {
          this.$router.push('')
        } else if (value === '月') {
