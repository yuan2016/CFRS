<template>
  <div class="loanThroughRate" v-loading="loading" element-loading-text="拼命加载中">
    ...
    <div class="date-filter">
      <el-select v-model.trim="model" size="mini" placeholder="请选择" class="loanThroughRateSelect" @change="goTo">
        <el-option
      ...
      <el-select v-model="value" size="mini" placeholder="TopN" @change="changeValue" class="loanThroughRateSelect">
        <el-option
    ...
    <el-table :data="fundData" highlight-current-row border stripe
              style="width: 100%;overflow: auto;" :height="height" class="loanThrough-table">
      ...
      <el-table-column property="DOD" :label="labels[8]" min-width="120"></el-table-column>
      <el-table-column property="W1" :label="labels[9]" min-width="120"></el-table-column>
      <el-table-column property="W2" :label="labels[10]" min-width="120"></el-table-column>
      <el-table-column property="W3" :label="labels[11]" min-width="120"></el-table-column>
      <el-table-column property="W4" :label="labels[12]" min-width="120"></el-table-column>
      <el-table-column property="WOW" :label="labels[13]" min-width="120"></el-table-column>
      ...
      <el-table-column property="MOM" :label="labels[17]" min-width="120"></el-table-column>
    </el-table>
    <div class="pop1">
...
<script type="text/ecmascript-6">
  ...
  import { getLoanThroughRate } from '../../../../../common/js/api'
  ...
  export default {
    ...
    methods: {
      goTo () {
        this.$router.push({path: '/RMAB/market/newUserPassRate/tab1'})
      },
      changeValue () {
        if (this.value === '0') {
