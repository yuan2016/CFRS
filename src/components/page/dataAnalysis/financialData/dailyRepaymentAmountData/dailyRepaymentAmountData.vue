<template>
  <div class="dailyRepaymentAmountData" v-loading.body="loading" element-loading-text="拼命加载中" >
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height" class="dailyRepaymentAmountData-table" @sort-change="sort">
      ...
      <el-table-column property="mature_money_nuser" label="新用户到期金额(元)" width="130"></el-table-column>
      <el-table-column property="overdue_money_nuser" label="新用户逾期金额(元)" width="130"></el-table-column>
      <el-table-column property="overdue_rate_nuser" label="新用户逾期率" width="100"></el-table-column>
      <el-table-column property="repayment_rate_nuser" label="新用户还款率" width="100"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getDailyRepaymentAmountData,
    getDailyRepaymentAmountDataCount,
    getDailyRepaymentAmountDataRefresh
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink () {
        return 'api/dailyRepaymentAmountData/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData () {
        return getDailyRepaymentAmountData({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount () {
        return getDailyRepaymentAmountDataCount({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
      ...
      refreshData () {
        ...
        getDailyRepaymentAmountDataRefresh().then((response) => {
