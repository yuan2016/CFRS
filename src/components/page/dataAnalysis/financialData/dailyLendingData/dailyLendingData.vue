<template>
  ...
  >
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto;" :height="height"
      ...
      <el-table-column property="loans_total_nuser" label="新用户放款总额(元)" width="140"></el-table-column>
      <el-table-column property="CHARGEBACK_FAILRATE" label="扣款失败率" width="100"></el-table-column>
      <el-table-column property="FULL_AMOUNT_RATE" label="满额率"></el-table-column>
      <el-table-column property="NUSER_FULL_AMOUNT_RATE" label="新用户满额率" width="110"></el-table-column>
      <el-table-column property="OUSER_FULL_AMOUNT_RATE" label="老用户满额率" width="110"></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  import {
    getDailyLendingData,
    getDailyLendingDataCount,
    getDailyLendingDataRefresh
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink() {
        return 'api/dailyLendingData/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getCount() {
        return getDailyLendingDataCount({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
      ...
      refreshData() {
        ...
        getDailyLendingDataRefresh().then((response) => {
