<template>
  <div class="daysStageStatistics90" v-loading.body="loading" element-loading-text="拼命加载中" >
    ...
    <el-table :data="fundData" highlight-current-row border stripe class="daysStageStatistics90-table"
      ...
      <el-table-column property="due_amount_f6" label="F6到期金额(元)" width="110"></el-table-column>
      ...
      <el-table-column property="TOTAL_LOAN_AMOUNT" label="累计借款总额(元)" width="120"></el-table-column>
      <el-table-column property="LOANING_AMOUNT" label="未到期未还款总额(元)" width="140"></el-table-column>
      <el-table-column property="REPAYMENTED_AMOUNT" label="已还总额(元)" width="100"></el-table-column>
    </el-table>
...
<script type="text/ecmascript-6">
  ...
  import {
    getDaysStageStatistics90,
    getDaysStageStatistics90Count,
    getDaysStageStatistics90Refresh
  } from '../../../../../common/js/api'
  ...
  export default {
    ...
    computed: {
      mosaicLink () {
        return 'api/daysStageStatistics90/excel?startTime="' + [this.startTime, 'DATE'] + '"&endTime="' + [this.endTime, 'DATE'] + '"'
      },
      ...mapGetters([
        'permission'
      ])
    ...
    methods: {
      ...
      getData () {
        return getDaysStageStatistics90({
          limit: this.limit,
          offset: this.offset,
      ...
      getCount () {
        return getDaysStageStatistics90Count({
          startTime: [this.startTime, 'DATE'],
          endTime: [this.endTime, 'DATE']
        })
      },
      ...
      refreshData () {
        ...
        getDaysStageStatistics90Refresh().then((response) => {
