<template>
  <div class="platformData" v-loading.body="loading" element-loading-text="拼命加载中">
    ...
    <el-table :data="fundData" highlight-current-row border stripe class="platformData-table"
      ...
      <el-table-column property="realname_fee" label="实名费用(元)" width="100"></el-table-column>
      ...
      <el-table-column property="operator_fee" label="运营商费用(元)" width="110"></el-table-column>
      ...
      <el-table-column property="Sesame_auth_fee" label="芝麻认证费用(元)" width="120"></el-table-column>
      ...
      <el-table-column property="Order_through_rate" label="订单通过率" width="100"></el-table-column>
      <el-table-column property="total_payloans_amount" label="应放款总额(元)" width="110"></el-table-column>
      <el-table-column property="total_succloan_amount" label="放款成功总额(元)" width="120"></el-table-column>
