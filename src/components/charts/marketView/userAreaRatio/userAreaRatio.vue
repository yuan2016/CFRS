<template>
  <div class="userAreaRatio">
    <div id="userAreaRatio-pic" style="width: 100%;height: 100%;"></div>
  </div>
</template>
...
<script>
  ...
  import { getUserAreaRatio } from '../../../../common/js/api'
  ...
  export default {
    ...
    methods: {
      ...
      initData () {
        this.chart = echarts.init(document.getElementById('userAreaRatio-pic'))
        const option = {
          //标题
          title: {
            text: '用户区域占比',
