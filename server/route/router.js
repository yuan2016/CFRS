...
let promotionStatisticsQEClassify = require('../controller/toyGrab/market/promotionStatisticsQEClassify/promotionStatisticsQEClassify')
...
router.post(api.promotionStatisticsQEClassify, promotionStatisticsQEClassify.fetchAll)
router.post(api.promotionStatisticsQEClassifyUpdate, promotionStatisticsQEClassify.update)
router.get(api.promotionStatisticsQEClassifyExcel, promotionStatisticsQEClassify.getExcelData)
router.get(api.promotionStatisticsQEClassifyExcelSUM, promotionStatisticsQEClassify.getExcelSUMData)
router.post(api.promotionStatisticsQEClassifySUM, promotionStatisticsQEClassify.fetchAllSUM)
router.post(api.promotionStatisticsQEClassifyGetOptions, promotionStatisticsQEClassify.getSelectOptions)
//用户充值间隔分析
