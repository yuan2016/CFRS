...
module.exports = {
  ...
  promotionOPPOStatisticsQEExcel: path + '/promotionOPPOStatisticsQE/excel',
  promotionOPPOStatisticsQEExcelSUM: path + '/promotionOPPOStatisticsQE/excelSUM',
  promotionOPPOStatisticsQEUpdate: path + '/promotionOPPOStatisticsQE/update',
  promotionOPPOStatisticsQESUM: path + '/promotionOPPOStatisticsQE/sum',
  //用户充值间隔分析
